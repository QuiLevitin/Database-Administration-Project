        ...
        <nav class="navbar navbar-expand-lg custom_nav-container pt-3">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                <li class="nav-item">
                  <a class="nav-link" href="admin.php"> Database <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
...
<section class="about_section">
    ...
    <table id="products">
      ...
      $sql = "SELECT  InvoiceNumber, OrderDate, DueDate  FROM salesinfo";
...
<section class="about_section layout_padding-spacer">
  ...
  <section  class="about_section">
    ...
    <table id="products">
      ...
      $sql = "SELECT ProductCode, InvoiceNumber, Description, ProductType, Quantity, Price, GrossAmount, Discount, NetAmount, FactoredAmount  FROM productinfo";
      $result = $conn->query($sql);
      if ($result->num_rows > 0) {
          // output data of each row
          while($row = $result->fetch_assoc()) {
